...
//This file is a copy of UnityEditor.PostPrecessing.ReflectionUtil
// ReSharper disable once CheckNamespace
namespace UnityTools.SceneManagement
{
    public static class ReflectionUtils
    {
        static readonly Dictionary<KeyValuePair<object, string>, FieldInfo> r_FieldInfoFromPaths = new Dictionary<KeyValuePair<object, string>, FieldInfo>();
        ...
        public static FieldInfo GetFieldInfoFromPath(object source, string path)
        {
            ...
            if (!r_FieldInfoFromPaths.TryGetValue(kvp, out field))
            {
                ...
                r_FieldInfoFromPaths.Add(kvp, field);
            }
